  ...
  return (
    <div className="bg-white border rounded-xl overflow-hidden hover:shadow-md transition-shadow"
      ...
      <div className="px-3 py-2 border-b grid grid-cols-2 gap-2" style={{borderColor:C.g100}}>
        <div>
          <p className="text-xs font-black uppercase tracking-wide mb-0.5" style={{color:C.g500}}>You Send</p>
          <p className="text-sm font-black leading-tight" style={{color:C.g800}}>₿ {fBtc(exampleBtc)}</p>
          <p className="text-xs font-semibold" style={{color:C.g400}}>BTC</p>
        </div>
        ...
        <div className="bg-white rounded-xl border p-3" style={{borderColor:C.g200}}>
          <div className="flex flex-wrap gap-2 items-end">
            ...
            <div className="flex-1 min-w-[120px]">
              <label className="text-xs font-black uppercase tracking-wide" style={{color:C.g500}}>Search Buyer</label>
            ...
            {/* BTC amount */}
            <div className="flex-1 min-w-[120px]">
              <label className="text-xs font-black uppercase tracking-wide" style={{color:C.g500}}>Sell BTC Amount</label>
              <div className="relative mt-0.5">
              ...
              {sellAmt&&<p className="text-xs mt-0.5" style={{color:C.sell}}>≈ {sym}{fmt(estLocal)} {cur}</p>}
            </div>
            ...
            <button onClick={()=>navigate('/create-offer')}
              ...
              <PlusCircle size={14}/> Post Buy Offer
            </button>
          </div>
